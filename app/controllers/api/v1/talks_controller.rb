class Api::V1::TalksController < ApplicationController
  ...
  def index
    ...
    @talks = Talk.includes([:conference, :conference_day, :talk_time, :talk_difficulty, :talk_category, :talks_speakers, :video, :speakers, :sponsor, :registered_talks]).accepted_and_intermission.where(query)
