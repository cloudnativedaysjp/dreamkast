...
EOS
  },
  {
    ...
    capacity: 300,
    about: <<'EOS'
    CloudNative Daysは、参加者が新たな技術や仲間との出会いを通じて、未来への一歩を踏み出す感動的な瞬間を体験する場です。イベントを通じて、様々なバックグラウンドを持つ参加者との交流や共有が、新たな「縁」となり、素晴らしい出会いや気づきを生み出すきっかけとなるかもしれません。この夏、CloudNative Daysで新たな出会いと学びの旅に出かけましょう。 (TBD)
EOS
  },
  {
    id: 110,
