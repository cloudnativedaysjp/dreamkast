...
ActiveRecord::Schema.define(version: 2022_01_01_082455) do
  ...
  create_table "aws_media_package_channels", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.bigint "conference_id", null: false
    t.bigint "track_id", null: false
    t.string "channel_id"
    t.index ["conference_id"], name: "index_aws_media_package_channels_on_conference_id"
    t.index ["track_id"], name: "index_aws_media_package_channels_on_track_id"
  end
  ...
  add_foreign_key "aws_media_package_channels", "conferences"
  add_foreign_key "aws_media_package_channels", "tracks"
