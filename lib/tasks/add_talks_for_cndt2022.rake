...
namespace :util do
  ...
  task add_talks_for_cndt2022: :environment do
    ...
    track_a_talks = [
      ['09:00:00', '09:45:00', '開始までしばらくお待ちください', 'intermission'],
      ['09:45:00', '10:00:00', 'オープニング', 'intermission'],
      #  10:00:00 12:15:00 Keynotes
      ['12:15:00', '13:20:00', '休憩', 'intermission'],
      #  13:20:00 14:00:00 Session
      ['14:00:00', '14:20:00', '休憩', 'intermission'],
      #  14:20:00 15:00:00 Session
      ['15:00:00', '15:20:00', '休憩', 'intermission'],
      #  15:20:00 16:00:00 Session
      ['16:00:00', '16:20:00', '休憩', 'intermission'],
      #  16:20:00 17:00:00 Session
      ['17:00:00', '17:20:00', '休憩', 'intermission'],
      #  17:20:00 18:00:00 Session
      ['18:00:00', '18:15:00', 'クロージング', 'intermission'],
      ['18:15:00', '20:00:00', '夜イベント(仮)', 'intermission'],
      ['20:00:00', '23:00:00', '本日のイベントは終了しました', 'intermission']
    ]

    other_track_talks = [
      ['09:00:00', '09:45:00', '開始までしばらくお待ちください', 'intermission'],
      ['09:45:00', '10:00:00', 'トラックAにてオープニングを配信中！', 'intermission'],
      ['10:00:00', '12:15:00', 'トラックAにてキーノートを配信中！', 'intermission'],
      ['12:15:00', '13:20:00', '休憩', 'intermission'],
      #  13:20:00 14:00:00 Session
      ['14:00:00', '14:20:00', '休憩', 'intermission'],
      #  14:20:00 15:00:00 Session
      ...
      ['17:00:00', '17:20:00', '休憩', 'intermission'],
      #  17:20:00 18:00:00 Session
      ['18:00:00', '18:15:00', 'トラックAにてクロージングを配信中！', 'intermission'],
      ['18:15:00', '20:00:00', 'トラックAにて夜イベント(仮)を配信中！', 'intermission'],
      ['20:00:00', '23:00:00', '本日のイベントは終了しました', 'intermission']
    ]
