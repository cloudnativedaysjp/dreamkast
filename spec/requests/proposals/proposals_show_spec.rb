...
describe ProposalsController, type: :request do
  ...
  describe 'GET /:event/proposals/:id' do
    ...
    context 'event is registered' do
      ...
      let!(:talk1) { create(:talk1, conference_id: cndt2020.id) }
      let!(:proposal) { create(:proposal, id: 1, conference_id: cndt2020.id, talk_id: talk1.id) }
